...
```
PS C:\Users\maxim> nmap -sS 10.33.81.100
...
```
PS C:\Users\maxim> nmap -O 10.33.81.100
...
```
PS C:\Users\maxim> nmap -sS 10.33.81.101
...
```
PS C:\Users\maxim> nmap -O 10.33.81.101
...
Les portes ne sont pas accessibles, car les detecteurs NFC sont des récépteurs et non des émetteurs, et donc ne peuvent pas être scannés.

## Lister toutes les adresses MAC et IP du réseau

```
PS C:\Users\maxim> nmap -sn 10.33.73.0/24
